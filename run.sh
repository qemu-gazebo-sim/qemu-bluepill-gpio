...
QEMU=/home/vander/Desktop/codes/TCC/qemu_stm32/build/arm-softmmu/qemu-system-arm
...
"$QEMU"                                                   \
	...
	-kernel ~/Desktop/codes/TCC/bluepill_gpio_sim/build/bluepill_gpio_sim_v1.bin \
	$NETPARAMS                                        \
	$QTESTPARAMS                                      \
	$LOGPARAMS                                        \
	# -curses                                           \
